  ...
  return (
    <div className="w-full p-8 rounded-lg bg-gradient-to-br from-emerald-50 to-teal-50 shadow-lg border border-emerald-200">
      <div className="flex items-center justify-between mb-6">
        <NavLink to="/" className="flex items-center justify-center w-9 h-9 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white transition-colors">
          {/* Back Arrow Icon */}
        ...
        <div className="flex items-center">
          {/* Map Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-emerald-600 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
